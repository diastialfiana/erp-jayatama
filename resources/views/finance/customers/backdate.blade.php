@extends('layouts.app')
@section('title', 'Customer Backdate')
@section('content')
    <div class="bg-white rounded-[14px] shadow-sm border border-gray-200 p-6">
        <h2 class="text-xl font-bold text-gray-800 mb-4">Customer Backdate</h2>
        <p class="text-gray-500">Backdate feature is coming soon.</p>
