@extends('layouts.app')
@section('title', 'List All - Department Account')
...
<style>
    ...
    /* Simulate selection highlight logic on click/down */
...
<div class="erp-container">
    <div class="erp-header">
        <div class="erp-tabs">
            <a href="{{ route('accounting.dept-account.detail') }}"><span>DETAIL</span></a>
    ...
    <div class="erp-body">
        ...
        <div class="grid-container">
            <table class="erp-table" id="deptTable">
                <thead>
                    <tr>
                        <th style="width: 15%">CODE</th>
                        <th style="width: 60%">DEPARTMENT DESCRIPTION</th>
                        <th style="width: 25%">AUDIT</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse($departments as $dept)
                    <tr onclick="window.location.href='{{ route('accounting.dept-account.detail', $dept->id) }}'">
                        <td>{{ $dept->code }}</td>
                        <td>{{ $dept->description }}</td>
                        <td>{{ $dept->audit ?? 'PASS' }}</td>
                    </tr>
                    @empty
                    <tr>
        ...
        <div class="footer-nav">
            ...
            <div>
                Record {{ $departments->isEmpty() ? '0' : '1' }} of {{ $departments->count() }}
            </div>
            <div class="nav-buttons">
