...
<div x-data="resourceServiceManager()" x-init="init()" style="background: white; border: 1px solid var(--hr-border); margin: 10px;">
    ...
    <div class="tab-content" style="border-top: none;">
        ...
        <div class="tab-pane" :class="activeMainTab === 'detail' ? 'active' : ''" style="background: #e2e8f0;">
            <!-- Header forms -->
            <div class="detail-form-area" style="padding-top:20px; position: relative;">
                <div style="display:flex; gap: 20px;">
                    <div>
                        <div class="form-group">
                            <div class="form-label">Date</div>
                            <select class="form-select" style="width: 140px;"><option>02/01/2018</option></select>
                        ...
                        <div class="form-group">
                            ...
                            <div style="display:flex;">
                                <input type="text" class="form-input" style="width: 250px;" value="PT. BANK MEGA TBK">
                                <span style="border: 1px solid var(--hr-border); background:#f1f5f9; padding: 4px 6px; border-left:none; cursor: pointer; color:#64748b;">...</span>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-label">From Quotation</div>
                            <div style="display:flex; margin-right: 15px;">
                                <input type="text" class="form-input" style="width: 160px;">
                                <span style="border: 1px solid var(--hr-border); background:#f1f5f9; padding: 4px 6px; border-left:none; cursor: pointer;">
                            ...
                            <select class="form-select" style="width: 120px;"><option>09/05/2018</option></select>
                        ...
                        <div class="form-group">
                            ...
                            <div style="display:flex;">
                                <input type="text" class="form-input" style="width: 210px;">
                ...
                <div style="display:flex; flex-direction:column; align-items:flex-end; justify-content:space-between;">
                    ...
                    <div style="font-size: 1.4rem; font-weight: bold; color: #1e293b; padding-right: 5px; margin-bottom: 10px;">
                        rembursment
                    </div>
                </div>
            </div>
            ...
            <div class="bordered-panel">
                    ...
                    <table class="list-grid">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align:right; background:#e2e8f0;">10</td>
                                <td style="text-align:right; background:#e2e8f0;">2.000</td>
                                <td style="text-align:right; background:#e2e8f0;">20.000</td>
                                <td></td>
                            </tr>
                            <tr>
                                <td></td>
                ...
                <div class="grid-footer" style="padding: 2px 4px; min-height: 25px;">
                    ...
                    <span class="pager-btn" style="border:none; background:transparent;">Record 1 of 2</span>
                    <button class="pager-btn">▶</button> <button class="pager-btn">▶▶</button> <button class="pager-btn">▶|</button>
                </div>
            </div>
            ...
            <div style="padding: 10px; display: flex; justify-content: space-between; align-items: flex-start; background:#e2e8f0;">
                ...
                <div style="display:flex; flex-direction:column; gap:4px; margin-right: 10px;">
                    <div style="display:flex; justify-content:flex-end; align-items:center; gap:10px;">
                        ...
                        <div style="display:flex;">
                            <input type="text" class="form-input" style="width: 120px; text-align:right; border-right:none;" value="185.000">
                            <div style="display:flex; flex-direction:column; border: 1px solid var(--hr-border); background:#f8fafc;">
                               <span style="font-size:0.4rem; cursor:pointer; line-height: 0.5; padding: 2px;">▲</span>
                               <span style="font-size:0.4rem; cursor:pointer; line-height: 0.5; padding: 2px;">▼</span>
                            </div>
                        </div>
                    </div>
                    <div style="display:flex; justify-content:flex-end; align-items:center; gap:10px;">
                        ...
                        <input type="text" class="form-input" style="width: 135px; text-align:right;" value="0">
                    </div>
                    <div style="display:flex; justify-content:flex-end; align-items:center; gap:10px;">
                    ...
                    <div style="display:flex; justify-content:flex-end; align-items:center; gap:10px;">
                        ...
                        <input type="text" class="form-input" style="width: 135px; text-align:right; font-weight:bold;" value="160.000">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="tab-pane" :class="activeMainTab === 'list' ? 'active' : ''" style="background: white;">
            ...
            <div style="flex: 1; overflow: auto; border-top:1px solid var(--hr-border);">
                <table class="list-grid">
                    ...
                    <tbody>
                        <template x-for="(item, idx) in contracts" :key="idx">
                            <tr>
                                <td>
                                    <span style="display:inline-block; width:12px; height:12px; text-align:center; line-height:10px; border:1px solid #cbd5e1; cursor:pointer; color:#64748b; margin-right:5px; font-size: 0.6rem;">+</span>
